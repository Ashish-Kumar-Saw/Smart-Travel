...
def attract_activities_tool():
    ...
    attraction_tools = [
         ...
         Tool.from_function(
            name="Search_lodging",
            func=hotels().find_hotels,
            description="Tool to search for lodging options in the requested holiday destination. Location(format:str) is the input and output is in string format."
         )
         ]
